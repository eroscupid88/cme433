...
add wave -noupdate -radix unsigned /microprocessor_tb/cache_wroffset
add wave -noupdate -radix hexadecimal /microprocessor_tb/cache_rdoffset
add wave -noupdate -radix binary /microprocessor_tb/pc
add wave -noupdate -radix binary /microprocessor_tb/pm_address
add wave -noupdate -color Cyan -radix binary /microprocessor_tb/rom_address
add wave -noupdate /microprocessor_tb/cache_rdline
add wave -noupdate /microprocessor_tb/cache_wrline
add wave -noupdate -radix hexadecimal /microprocessor_tb/o_reg
add wave -noupdate -color Red -radix hexadecimal /microprocessor_tb/ir
...
add wave -noupdate /microprocessor_tb/tagID
add wave -noupdate /microprocessor_tb/valid
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {564929051 ps} 0}
...
update
WaveRestoreZoom {557835820 ps} {574242070 ps}
