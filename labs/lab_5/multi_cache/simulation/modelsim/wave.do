...
add wave -noupdate -color Cyan -radix hexadecimal /microprocessor_tb/rom_address
...
WaveRestoreCursors {{Cursor 1} {698500000 ps} 0}
...
update
WaveRestoreZoom {690296875 ps} {706703125 ps}
